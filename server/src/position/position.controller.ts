...
import { ApiTags, ApiParam, ApiQuery, ApiOkResponse, ApiBadRequestResponse, ApiNotFoundResponse, ApiOperation } from "@nestjs/swagger";
...
export class PositionController {
    ...
    @ApiOperation({
        ...
        description: 'Add a new position. It is required that the `device` property is set.'
    })
    ...
    async addPosition(@Res() res, @Body() createPositionDto: CreatePositionDTO) {
        if (!createPositionDto.device || !Types.ObjectId.isValid(createPositionDto.device as unknown as Types.ObjectId)) {
